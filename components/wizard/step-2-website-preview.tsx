...
import type { Phase2AnalysisResult, WizardFormData } from '@/app/page';
  ...
  return (
    <div className="space-y-8 pb-4">
      <div className="flex flex-col gap-4 border-b border-border pb-6 sm:flex-row sm:items-start sm:justify-between">
        <div><p className="text-xs font-semibold uppercase tracking-[0.14em] text-primary">STEP 02 / AI RECOMMENDATIONS</p><h2 className="mt-3 text-3xl font-semibold tracking-tight text-foreground md:text-4xl">AI Recommendation Preview</h2><p className="mt-3 max-w-2xl text-sm leading-6 text-muted-foreground">See how AI responded to the recommendation question you selected.</p></div>
